...
public class ArcView extends ShapeOfView {
    ...
    public float arcHeightPx = 0.0f;

    public int arcPosition = 2;
    ...
    private void init(Context context, AttributeSet attributeSet) {
        if (attributeSet != null) {
            int[] ArcView = {R.attr.shape_arc_height, R.attr.shape_arc_position};
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet,ArcView);
            this.arcHeightPx = (float) obtainStyledAttributes.getDimensionPixelSize(0, (int) this.arcHeightPx);
        ...
        super.setClipPathCreator(new ClipPathManager.ClipPathCreator() {
            ...
            public Path createClipPath(int i, int i2) {
                ...
                int access$100 = ArcView.this.arcPosition;
                if (access$100 != 1) {
                    if (access$100 != 2) {
                        if (access$100 != 3) {
                            if (access$100 == 4) {
