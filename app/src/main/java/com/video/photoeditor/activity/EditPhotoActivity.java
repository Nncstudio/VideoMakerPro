...
import com.video.maker.util.ColorFilterGenerator;
import com.video.maker.view.RoundViewDelegate;
import com.video.photoeditor.adapter.ColorAdapter;
import com.video.photoeditor.adapter.ViewPagerAdapter;
import com.video.photoeditor.dialog.DiscardDialog;
import com.video.photoeditor.fragment.ColorFragment;
import com.video.photoeditor.fragment.EmojiFragment;
import com.video.photoeditor.fragment.OverlaysFragment;
import com.video.photoeditor.fragment.Overplay.ChristmasFragment;
import com.video.photoeditor.fragment.Overplay.FoodFragment;
import com.video.photoeditor.fragment.Overplay.LoveFragment;
import com.video.photoeditor.fragment.Overplay.MotivationFragment;
import com.video.photoeditor.fragment.Overplay.PhrasesFragment;
import com.video.photoeditor.fragment.Overplay.SayingsFragment;
import com.video.photoeditor.fragment.Overplay.SummerFragment;
import com.video.photoeditor.fragment.Overplay.TravelFragment;
import com.video.photoeditor.fragment.Overplay.WinterFragment;
import com.video.photoeditor.fragment.Sticker.StickerFragment;
import com.video.photoeditor.fragment.TextEditorDialog;
import com.video.photoeditor.fragment.TuneImage.TuneFragment;
import com.video.photoeditor.fragment.texttools.FontFragment;
import com.video.photoeditor.fragment.texttools.FormatTextFragment;
import com.video.photoeditor.fragment.texttools.HightLightTextFragment;

import com.video.photoeditor.fragment.texttools.SpacingTextFragment;
import com.video.photoeditor.fragment.texttools.StrokeTextFragment;
import com.video.photoeditor.interfaces.ColorFragmentListener;
import com.video.photoeditor.interfaces.FontFragmentListener;
import com.video.photoeditor.interfaces.FormatTextFragmentListener;
import com.video.photoeditor.interfaces.HightLightFragmentListener;
import com.video.photoeditor.interfaces.OverlayListener;
import com.video.photoeditor.interfaces.OverlaysFragmentListener;
import com.video.photoeditor.interfaces.ShadowFragmentListener;
import com.video.photoeditor.interfaces.SpacingFragmentListener;
import com.video.photoeditor.interfaces.StrokeFragmentListener;
import com.video.photoeditor.photoeditor.OnPhotoEditorListener;
import com.video.photoeditor.photoeditor.PhotoEditor;
import com.video.photoeditor.photoeditor.PhotoEditorView;
import com.video.photoeditor.photoeditor.SaveSettings;
import com.video.photoeditor.photoeditor.ViewType;
import com.video.photoeditor.utils.BitmapProcess;
import com.video.photoeditor.utils.ViewAnimation;
import com.video.photoeditor.view.RoundFrameLayout;
import com.video.photoeditor.view.StrokeTextView;
import com.video.maker.R;
import com.video.maker.activities.BaseActivity;
...
public class EditPhotoActivity extends BaseActivity implements View.OnClickListener,
        OnPhotoEditorListener, FormatTextFragmentListener, FontFragmentListener, HightLightFragmentListener, ColorFragmentListener, SpacingFragmentListener, StrokeFragmentListener, ShadowFragmentListener, EmojiFragment.EmojiListener, StickerFragment.StickerFragmentListener, OverlayListener, OverlaysFragmentListener, TuneFragment.TuneFragmentListener, TextEditorDialog.TextFragmentListener {
...
//                ColorPickerDialogBuilder.with(EditPhotoActivity.this).setTitle("Select color").wheelType(
//                        ColorPickerView.WHEEL_TYPE.FLOWER).density(12).setPositiveButton((CharSequence) "OK", (ColorPickerClickListener) new ColorPickerClickListener() {
...
//                }).build().show();
    ...
    private void setupTabIconsTextTool() {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            TextViewCompat.setCompoundDrawableTintList(textView7, tabColors);
            textView7.setTextColor(tabColors);
        }

        TextViewCompat.setCompoundDrawableTintList(textView, tabColors);
        textView.setTextColor(tabColors);
        TextViewCompat.setCompoundDrawableTintList(textView2, tabColors);
        textView2.setTextColor(tabColors);
        TextViewCompat.setCompoundDrawableTintList(textView3, tabColors);
        textView3.setTextColor(tabColors);
        TextViewCompat.setCompoundDrawableTintList(textView5, tabColors);
        textView5.setTextColor(tabColors);
        TextViewCompat.setCompoundDrawableTintList(textView6, tabColors);
        textView6.setTextColor(tabColors);
...
//    int tintColor = Color.parseColor("#7555FB"); // Replace with your desired color
//        ImageViewCompat.setImageTintList(textView, ColorStateList.valueOf(tintColor));
    ...
    private void setupTabIconsImageTool() {
        ...
        textView.setImageResource( R.drawable.ic_add_sticker);

        // Create a ColorStateList with the desired colors for selected and unselected states
        int[][] states = new int[][] {
                new int[] { android.R.attr.state_selected }, // selected state
                new int[] { -android.R.attr.state_selected } // unselected state
        };
        ...
        textView2.setImageResource( R.drawable.ic_overplay);
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            textView3.setImageResource(R.drawable.ic_emoji);
        ...
        textView4.setImageResource(R.drawable.ic_add_text);
        ...
        textView5.setImageResource(R.drawable.ic_tune);

        // Apply the ColorStateList as the tint for the ImageView
    ...
    private void savePhoto() {
        ProgressDialog progressDialog2 = new ProgressDialog(EditPhotoActivity.this);
...
//            super.onPreExecute();
//            progressDialog2 = new ProgressDialog(EditPhotoActivity.this);
//            progressDialog2.setMessage(getString(R.string.com_facebook_loading));
//            progressDialog2.setCanceledOnTouchOutside(false);
//            progressDialog2.show();
//        }
