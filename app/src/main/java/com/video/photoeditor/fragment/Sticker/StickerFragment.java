package com.video.photoeditor.fragment.Sticker;
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            for (int i2 = 0; i2 < childCount2; i2++) {
                ...
                if (childAt instanceof TextView) {
                    ((TextView) childAt).setTypeface(Typeface.createFromAsset(getActivity().getAssets(), new StringBuilder("font/comic.ttf").toString()));
                }
            }
        }
    }
